...
def parse_args():
    ...
    parser.add_argument(
        "--train_data_dir", type=str, default='/root/autodl-tmp/inspiration_tree/input_concepts/red_bird/v0', required=False, help="A folder containing the training data."
    )
    parser.add_argument(
        "--placeholder_token",
        type=str,
    ...
    parser.add_argument(
        "--initializer_token", type=str, default="object", help="A token to use as initializer word."
    )
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/root/autodl-tmp/inspiration_tree/outputs_ti/red_bird",
...
def main():
    ...
    utils.save_rev_samples(args.output_dir, save_path, MODEL_ID, device)
