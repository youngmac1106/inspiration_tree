...
def parse_args(): 
    ...
    parser.add_argument("--parent_data_dir", type=str, default='mug_buildings/',help="Path to directory with the training samples")
    ...
    parser.add_argument("--best_seed",type=int,default=1234)
